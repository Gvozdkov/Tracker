...
enum LocalizableKeys {
    ...
    static let trackerVCUnpin = "Unpin".localised()
    static let trackerVCPin = "trackerVCPin".localised()
    static let trackerVCEdit = "trackerVCEdit".localised()
    static let trackerVCDelete = "trackerVCDelete".localised()
    ...
    static let newTrackerVCIrregularEvents = "newTrackerVCIrregularEvents".localised()
